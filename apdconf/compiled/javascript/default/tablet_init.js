$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock-clock"] = new baseclock("default-clock-clock", "", "default", {'css': {}, 'static_icons': [], 'precision': 1, 'title_is_friendly_name': 1, 'use_hass_icon': 1, 'namespace': 'default', 'use_comma': 0, 'fields': {'date': '', 'time': ''}, 'widget_type': 'baseclock', 'static_css': {'time_style': 'color: #aa00ff;', 'widget_style': 'background-color: #444;', 'date_style': 'color: #fff;'}, 'entity': 'clock.clock', 'icons': []})
        ...
        widgets["default-sensor-cpu-temp"] = new basedisplay("default-sensor-cpu-temp", "", "default", {'fields': {'title': '', 'title2': '', 'state_text': '', 'value': '', 'unit': ''}, 'static_icons': [], 'precision': 1, 'sub_entity': '', 'title_is_friendly_name': 1, 'sub_entity_to_entity_attribute': '', 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'container_style': '', 'state_text_style': 'font-size: 100%;color: #fff;', 'widget_style': 'background-color: #444;'}, 'use_comma': 0, 'css': {'value_style': 'font-size: 250%;color: #00aaff;', 'unit_style': 'font-size: 100%;color: #00aaff;', 'text_style': 'font-size: 100%;color: #fff;'}, 'widget_type': 'basedisplay', 'entity': 'sensor.cpu_temp', 'icons': [], 'namespace': 'default', 'entity_to_sub_entity_attribute': ''})
        ...
        widgets["default-light-bar-light"] = new baselight("default-light-bar-light", "", "default", {'fields': {'title2': '', 'icon': '', 'state_text': '', 'icon_style': '', 'level': '', 'units': '%', 'title': ''}, 'static_icons': {'icon_down': 'fas-minus', 'icon_up': 'fas-plus'}, 'precision': 1, 'post_service_active': {'entity_id': 'light.bar_light', 'service': 'homeassistant/turn_on'}, 'title_is_friendly_name': 1, 'post_service_inactive': {'entity_id': 'light.bar_light', 'service': 'homeassistant/turn_off'}, 'use_hass_icon': 1, 'static_css': {'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'level_up_style': 'color: #888;', 'widget_style': 'background-color: #444;', 'title_style': 'color: #fff;', 'unit_style': 'color: #fff;', 'level_down_style': 'color: #888;', 'level_style': 'color: #fff;'}, 'use_comma': 0, 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'widget_type': 'baselight', 'entity': 'light.bar_light', 'namespace': 'default', 'icons': {'icon_on': 'fas-circle', 'icon_off': 'far-circle'}})
        ...
        widgets["default-switch-christmas-tree"] = new baseswitch("default-switch-christmas-tree", "", "default", {'fields': {'title': '', 'title2': '', 'icon': '', 'state_text': '', 'icon_style': ''}, 'static_icons': [], 'enable': 1, 'precision': 1, 'post_service_active': {'entity_id': 'switch.christmas_tree', 'service': 'homeassistant/turn_on'}, 'title_is_friendly_name': 1, 'post_service_inactive': {'entity_id': 'switch.christmas_tree', 'service': 'homeassistant/turn_off'}, 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;'}, 'use_comma': 0, 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'widget_type': 'baseswitch', 'entity': 'switch.christmas_tree', 'state_active': 'on', 'state_inactive': 'off', 'namespace': 'default', 'icons': {'icon_on': 'fas-circle', 'icon_off': 'far-circle'}})
