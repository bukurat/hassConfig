$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock"] = new baseclock("default-clock", "", "obsidian", {'time_style': 'color: yellow;', 'css': {}, 'static_icons': [], 'precision': 1, 'namespace': 'default', 'widget_style': 'font-size: 200%;background:blue;', 'use_hass_icon': 1, 'static_css': {'time_style': 'color: yellow;', 'widget_style': 'border-style: solid;border-color: white;background:blue;font-size: 200%;border-width: 2px;', 'date_style': 'font-size: 150%;color: red;'}, 'use_comma': 0, 'fields': {'date': '', 'time': ''}, 'date_style': 'color: red;', 'widget_type': 'baseclock', 'icons': []})
    
        widgets["default-dht-sensor-temperature"] = new basedisplay("default-dht-sensor-temperature", "", "obsidian", {'fields': {'title': 'Computer Room Temperature', 'title2': '', 'state_text': '', 'value': '', 'unit': ''}, 'static_icons': [], 'precision': 1, 'sub_entity': '', 'namespace': 'default', 'sub_entity_to_entity_attribute': '', 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'container_style': '', 'state_text_style': 'font-size: 100%;color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'css': {'value_style': 'font-size: 300%;color: #00FFFF;', 'unit_style': 'font-size: 95%;color: #00FFFF;', 'text_style': 'font-size: 100%;color: #00FFFF;'}, 'widget_type': 'basedisplay', 'icons': [], 'entity': 'sensor.dht_sensor_temperature', 'entity_to_sub_entity_attribute': ''})
    
        widgets["default-dht-sensor-humidity"] = new basedisplay("default-dht-sensor-humidity", "", "obsidian", {'fields': {'title': 'Computer Room Humidity', 'title2': '', 'state_text': '', 'value': '', 'unit': ''}, 'static_icons': [], 'precision': 1, 'sub_entity': '', 'namespace': 'default', 'sub_entity_to_entity_attribute': '', 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'container_style': '', 'state_text_style': 'font-size: 100%;color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'css': {'value_style': 'font-size: 300%;color: #00FFFF;', 'unit_style': 'font-size: 95%;color: #00FFFF;', 'text_style': 'font-size: 100%;color: #00FFFF;'}, 'widget_type': 'basedisplay', 'icons': [], 'entity': 'sensor.dht_sensor_humidity', 'entity_to_sub_entity_attribute': ''})
    
        widgets["default-sensor-load-1m"] = new basedisplay("default-sensor-load-1m", "", "obsidian", {'fields': {'title': '', 'title2': '', 'state_text': '', 'value': '', 'unit': ''}, 'static_icons': [], 'precision': 1, 'sub_entity': '', 'title_is_friendly_name': 1, 'sub_entity_to_entity_attribute': '', 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'container_style': '', 'state_text_style': 'font-size: 100%;color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'css': {'value_style': 'font-size: 300%;color: #00FFFF;', 'unit_style': 'font-size: 95%;color: #00FFFF;', 'text_style': 'font-size: 100%;color: #00FFFF;'}, 'widget_type': 'basedisplay', 'entity': 'sensor.load_1m', 'icons': [], 'namespace': 'default', 'entity_to_sub_entity_attribute': ''})
    
        widgets["default-sensor-load-15m"] = new basedisplay("default-sensor-load-15m", "", "obsidian", {'fields': {'title': '', 'title2': '', 'state_text': '', 'value': '', 'unit': ''}, 'static_icons': [], 'precision': 1, 'sub_entity': '', 'title_is_friendly_name': 1, 'sub_entity_to_entity_attribute': '', 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'container_style': '', 'state_text_style': 'font-size: 100%;color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'css': {'value_style': 'font-size: 300%;color: #00FFFF;', 'unit_style': 'font-size: 95%;color: #00FFFF;', 'text_style': 'font-size: 100%;color: #00FFFF;'}, 'widget_type': 'basedisplay', 'entity': 'sensor.load_15m', 'icons': [], 'namespace': 'default', 'entity_to_sub_entity_attribute': ''})
    
        widgets["default-cpu-temp"] = new basedisplay("default-cpu-temp", "", "obsidian", {'fields': {'title': 'CPU Temperature', 'title2': '', 'state_text': '', 'value': '', 'unit': ''}, 'static_icons': [], 'precision': 1, 'sub_entity': '', 'namespace': 'default', 'sub_entity_to_entity_attribute': '', 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'container_style': '', 'state_text_style': 'font-size: 100%;color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'icon': 'mdi-raspberrypi', 'css': {'value_style': 'font-size: 300%;color: #00FFFF;', 'unit_style': 'font-size: 95%;color: #00FFFF;', 'text_style': 'font-size: 100%;color: #00FFFF;'}, 'widget_type': 'basedisplay', 'icons': [], 'use_comma': 0, 'entity': 'sensor.cpu_temp', 'entity_to_sub_entity_attribute': ''})
    
        widgets["default-sensor-disk-use-percent"] = new basedisplay("default-sensor-disk-use-percent", "", "obsidian", {'fields': {'title': '', 'title2': '', 'state_text': '', 'value': '', 'unit': ''}, 'static_icons': [], 'precision': 1, 'sub_entity': '', 'title_is_friendly_name': 1, 'sub_entity_to_entity_attribute': '', 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'container_style': '', 'state_text_style': 'font-size: 100%;color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'css': {'value_style': 'font-size: 300%;color: #00FFFF;', 'unit_style': 'font-size: 95%;color: #00FFFF;', 'text_style': 'font-size: 100%;color: #00FFFF;'}, 'widget_type': 'basedisplay', 'entity': 'sensor.disk_use_percent', 'icons': [], 'namespace': 'default', 'entity_to_sub_entity_attribute': ''})
    
        widgets["default-sensor-memory-use-percent"] = new basedisplay("default-sensor-memory-use-percent", "", "obsidian", {'fields': {'title': '', 'title2': '', 'state_text': '', 'value': '', 'unit': ''}, 'static_icons': [], 'precision': 1, 'sub_entity': '', 'title_is_friendly_name': 1, 'sub_entity_to_entity_attribute': '', 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'container_style': '', 'state_text_style': 'font-size: 100%;color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'css': {'value_style': 'font-size: 300%;color: #00FFFF;', 'unit_style': 'font-size: 95%;color: #00FFFF;', 'text_style': 'font-size: 100%;color: #00FFFF;'}, 'widget_type': 'basedisplay', 'entity': 'sensor.memory_use_percent', 'icons': [], 'namespace': 'default', 'entity_to_sub_entity_attribute': ''})
    
        widgets["default-sensor-disk-free"] = new basedisplay("default-sensor-disk-free", "", "obsidian", {'fields': {'title': '', 'title2': '', 'state_text': '', 'value': '', 'unit': ''}, 'static_icons': [], 'precision': 1, 'sub_entity': '', 'title_is_friendly_name': 1, 'sub_entity_to_entity_attribute': '', 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'container_style': '', 'state_text_style': 'font-size: 100%;color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'css': {'value_style': 'font-size: 300%;color: #00FFFF;', 'unit_style': 'font-size: 95%;color: #00FFFF;', 'text_style': 'font-size: 100%;color: #00FFFF;'}, 'widget_type': 'basedisplay', 'entity': 'sensor.disk_free', 'icons': [], 'namespace': 'default', 'entity_to_sub_entity_attribute': ''})
    
        widgets["default-input-boolean-front-door-lock"] = new baseswitch("default-input-boolean-front-door-lock", "", "obsidian", {'fields': {'title': '', 'title2': '', 'icon': '', 'state_text': '', 'icon_style': ''}, 'static_icons': [], 'enable': 1, 'precision': 1, 'post_service_active': {'entity_id': 'input_boolean.front_door_lock', 'service': 'homeassistant/turn_on'}, 'title_is_friendly_name': 1, 'post_service_inactive': {'entity_id': 'input_boolean.front_door_lock', 'service': 'homeassistant/turn_off'}, 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'css': {'icon_style_active': 'color: #00FFFF;', 'icon_style_inactive': 'color: #888;'}, 'widget_type': 'baseswitch', 'entity': 'input_boolean.front_door_lock', 'state_active': 'on', 'state_inactive': 'off', 'namespace': 'default', 'icons': {'icon_on': 'fas-sliders-h', 'icon_off': 'fas-sliders-h'}})
    
        widgets["default-light-salt-lamp"] = new baselight("default-light-salt-lamp", "", "obsidian", {'fields': {'title2': '', 'icon': '', 'state_text': '', 'icon_style': '', 'level': '', 'units': '%', 'title': ''}, 'static_icons': {'icon_down': 'fas-minus', 'icon_up': 'fas-plus'}, 'precision': 1, 'post_service_active': {'entity_id': 'light.salt_lamp', 'service': 'homeassistant/turn_on'}, 'title_is_friendly_name': 1, 'post_service_inactive': {'entity_id': 'light.salt_lamp', 'service': 'homeassistant/turn_off'}, 'use_hass_icon': 1, 'static_css': {'title2_style': 'color: #fff;', 'state_text_style': 'color: #00FFFF;', 'level_up_style': 'color: #888;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);', 'title_style': 'color: #fff;', 'unit_style': 'color: #888;', 'level_down_style': 'color: #888;', 'level_style': 'color: #888;'}, 'use_comma': 0, 'css': {'icon_style_active': 'color: #00FFFF;', 'icon_style_inactive': 'color: #888;'}, 'widget_type': 'baselight', 'entity': 'light.salt_lamp', 'namespace': 'default', 'icons': {'icon_on': 'fas-circle', 'icon_off': 'far-circle'}})
    
        widgets["default-light-lounge-curtain-light"] = new baselight("default-light-lounge-curtain-light", "", "obsidian", {'fields': {'title2': '', 'icon': '', 'state_text': '', 'icon_style': '', 'level': '', 'units': '%', 'title': ''}, 'static_icons': {'icon_down': 'fas-minus', 'icon_up': 'fas-plus'}, 'precision': 1, 'post_service_active': {'entity_id': 'light.lounge_curtain_light', 'service': 'homeassistant/turn_on'}, 'title_is_friendly_name': 1, 'post_service_inactive': {'entity_id': 'light.lounge_curtain_light', 'service': 'homeassistant/turn_off'}, 'use_hass_icon': 1, 'static_css': {'title2_style': 'color: #fff;', 'state_text_style': 'color: #00FFFF;', 'level_up_style': 'color: #888;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);', 'title_style': 'color: #fff;', 'unit_style': 'color: #888;', 'level_down_style': 'color: #888;', 'level_style': 'color: #888;'}, 'use_comma': 0, 'css': {'icon_style_active': 'color: #00FFFF;', 'icon_style_inactive': 'color: #888;'}, 'widget_type': 'baselight', 'entity': 'light.lounge_curtain_light', 'namespace': 'default', 'icons': {'icon_on': 'fas-circle', 'icon_off': 'far-circle'}})
    
        widgets["default-input-boolean-nathan-lamp-switch"] = new baseswitch("default-input-boolean-nathan-lamp-switch", "", "obsidian", {'fields': {'title': '', 'title2': '', 'icon': '', 'state_text': '', 'icon_style': ''}, 'static_icons': [], 'enable': 1, 'precision': 1, 'post_service_active': {'entity_id': 'input_boolean.nathan_lamp_switch', 'service': 'homeassistant/turn_on'}, 'title_is_friendly_name': 1, 'post_service_inactive': {'entity_id': 'input_boolean.nathan_lamp_switch', 'service': 'homeassistant/turn_off'}, 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'css': {'icon_style_active': 'color: #00FFFF;', 'icon_style_inactive': 'color: #888;'}, 'widget_type': 'baseswitch', 'entity': 'input_boolean.nathan_lamp_switch', 'state_active': 'on', 'state_inactive': 'off', 'namespace': 'default', 'icons': {'icon_on': 'fas-sliders-h', 'icon_off': 'fas-sliders-h'}})
    
        widgets["default-bar-light"] = new baselight("default-bar-light", "", "obsidian", {'fields': {'title2': '', 'icon': 'mdi-white-balance-iridescent', 'state_text': '', 'icon_style': '', 'level': '', 'units': '%', 'title': 'Bar Light'}, 'static_icons': {'icon_down': 'fas-minus', 'icon_up': 'fas-plus'}, 'precision': 1, 'post_service_active': {'entity_id': 'light.bar_light', 'service': 'homeassistant/turn_on'}, 'namespace': 'default', 'post_service_inactive': {'entity_id': 'light.bar_light', 'service': 'homeassistant/turn_off'}, 'use_hass_icon': 1, 'static_css': {'title2_style': 'color: #fff;', 'state_text_style': 'color: #00FFFF;', 'level_up_style': 'color: #888;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);', 'title_style': 'color: #fff;', 'unit_style': 'color: #888;', 'level_down_style': 'color: #888;', 'level_style': 'color: #888;'}, 'icon': 'mdi-white-balance-iridescent', 'css': {'icon_style_active': 'color: #00FFFF;', 'icon_style_inactive': 'color: #888;'}, 'widget_type': 'baselight', 'use_comma': 0, 'entity': 'light.bar_light', 'icons': {'icon_on': 'fas-circle', 'icon_off': 'far-circle'}})
    
        widgets["default-light-reading-light"] = new baselight("default-light-reading-light", "", "obsidian", {'fields': {'title2': '', 'icon': '', 'state_text': '', 'icon_style': '', 'level': '', 'units': '%', 'title': ''}, 'static_icons': {'icon_down': 'fas-minus', 'icon_up': 'fas-plus'}, 'precision': 1, 'post_service_active': {'entity_id': 'light.reading_light', 'service': 'homeassistant/turn_on'}, 'title_is_friendly_name': 1, 'post_service_inactive': {'entity_id': 'light.reading_light', 'service': 'homeassistant/turn_off'}, 'use_hass_icon': 1, 'static_css': {'title2_style': 'color: #fff;', 'state_text_style': 'color: #00FFFF;', 'level_up_style': 'color: #888;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);', 'title_style': 'color: #fff;', 'unit_style': 'color: #888;', 'level_down_style': 'color: #888;', 'level_style': 'color: #888;'}, 'use_comma': 0, 'css': {'icon_style_active': 'color: #00FFFF;', 'icon_style_inactive': 'color: #888;'}, 'widget_type': 'baselight', 'entity': 'light.reading_light', 'namespace': 'default', 'icons': {'icon_on': 'fas-circle', 'icon_off': 'far-circle'}})
    
        widgets["default-switch-workshop-power"] = new baseswitch("default-switch-workshop-power", "", "obsidian", {'fields': {'title': '', 'title2': '', 'icon': '', 'state_text': '', 'icon_style': ''}, 'static_icons': [], 'enable': 1, 'precision': 1, 'post_service_active': {'entity_id': 'switch.workshop_power', 'service': 'homeassistant/turn_on'}, 'title_is_friendly_name': 1, 'post_service_inactive': {'entity_id': 'switch.workshop_power', 'service': 'homeassistant/turn_off'}, 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #00FFFF;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'css': {'icon_style_active': 'color: #00FFFF;', 'icon_style_inactive': 'color: #888;'}, 'widget_type': 'baseswitch', 'entity': 'switch.workshop_power', 'state_active': 'on', 'state_inactive': 'off', 'namespace': 'default', 'icons': {'icon_on': 'fas-circle', 'icon_off': 'far-circle'}})
    
        widgets["default-reload"] = new basejavascript("default-reload", "", "obsidian", {'fields': {'title2': '', 'icon': '', 'title': 'Reload', 'icon_style': ''}, 'static_icons': [], 'precision': 1, 'icon_inactive': 'fa-refresh', 'namespace': 'default', 'use_hass_icon': 1, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'widget_style': 'background-image: url(css/obsidian/img/obsidian_w_bg.jpg);'}, 'use_comma': 0, 'icon_active': 'fa-refresh', 'icons': {'icon_inactive': 'fa-refresh', 'icon_active': 'fa-refresh'}, 'widget_type': 'basejavascript', 'command': 'location.reload(true)', 'css': {'icon_inactive_style': 'color: #fff;', 'icon_active_style': 'color: #00FFFF;'}})
